...
# 퍼스널컬러별 어울리는 색상 (톤에 맞는 색상 풀)
PERSONAL_COLOR_PALETTES = {
    'spring_warm': [
        # 봄 웜톤: 밝고 따뜻한 색상, 청명한 톤
        '주황색', '노란색', '연두색', '분홍색', '금색',
        '베이지색', '연갈색', '하늘색', '연보라색', '흰색'
    ],
    'summer_cool': [
        # 여름 쿨톤: 부드럽고 차분한 색상, 뮤트/소프트 톤
        '연보라색', '하늘색', '분홍색', '회색', '은색',
        '남색', '연두색', '베이지색', '흰색', '연분홍색'
    ],
    'autumn_warm': [
        # 가을 웜톤: 깊고 따뜻한 색상, 머스타드/카키 계열
        '갈색', '주황색', '베이지색', '금색', '진갈색',
        '초록색', '진한 빨간색', '노란색', '카키색', '연갈색'
    ],
    'winter_cool': [
        # 겨울 쿨톤: 선명하고 강렬한 색상, 대비감 있는 톤
        '빨간색', '파란색', '검은색', '흰색', '보라색',
        '남색', '은색', '분홍색', '진한 빨간색', '로열블루'
    ]
}

# 퍼스널컬러별 피해야 할 색상 (톤에 안 맞는 색상)
PERSONAL_COLOR_AVOID = {
    'spring_warm': ['검은색', '회색', '남색', '보라색'],  # 어둡고 탁한 색
    'summer_cool': ['주황색', '금색', '진갈색', '빨간색'],  # 선명하고 따뜻한 색
    'autumn_warm': ['분홍색', '연보라색', '하늘색', '은색'],  # 차갑고 밝은 색
    'winter_cool': ['베이지색', '연갈색', '카키색', '연두색']  # 탁하고 부드러운 색
}
