...
이 형식을 어기면 잘못된 응답입니다."""
    ...
    def _generate_fortune_texts(self, scores: Dict, zodiac_sign: str, chinese_zodiac: str, period_type: str = 'daily') -> Dict:
        ...
        total_templates_high = [
            ...
            f"행운이 가득한 하루가 예상됩니다. {afternoon_hours} 무렵 좋은 소식이나 기회가 찾아올 수 있으니 열린 마음으로 받아들이세요. 오늘은 새로운 시도나 도전에도 운이 따르는 날이니, 망설이던 일이 있다면 실행에 옮겨보세요. 주변의 도움도 기대할 수 있으며, 협력하면 더 큰 성과를 얻을 수 있습니다. 긍정적인 에너지로 하루를 가득 채워보세요.",
        ]
        total_templates_mid = [
            ...
            f"무난하게 흘러가는 평화로운 날입니다. 특별히 좋거나 나쁜 일은 없겠지만, {action_words_neutral} 자신의 할 일에 집중하면 뿌듯한 하루를 보낼 수 있습니다. {places}에서 잠시 여유를 갖는 것도 좋겠습니다. 가까운 사람들과 소통하며 마음의 안정을 찾아보세요. 오늘 하루도 감사하는 마음으로 마무리하세요.",
            f"평온한 기운 속에서 자신을 돌아보기 좋은 날입니다. {action_words_neutral} 진행하던 일들을 마무리하고, 새로운 계획을 세워보세요. {evening_hours}에는 휴식을 취하며 재충전의 시간을 가지면 좋겠습니다. 작은 것에 감사하는 마음이 더 큰 행복을 가져다줄 것입니다. 내일을 위한 준비를 차분히 해보세요.",
        ]
        total_templates_low = [
            ...
            f"조금은 조심스러운 하루가 될 수 있습니다. 중요한 결정이나 약속은 가능하면 연기하고, {action_words_negative} 하루를 보내세요. 사소한 일에도 신경이 쓰일 수 있으니, 마음을 편하게 먹는 것이 중요합니다. 무리하지 말고 자신의 페이스를 유지하면 무난히 넘길 수 있습니다. 충분한 수면이 내일의 활력을 가져다줄 것입니다.",
            f"재충전이 필요한 시기입니다. 오늘은 {action_words_negative} 에너지를 아끼고, 불필요한 외출이나 약속은 줄이세요. {places}에서 혼자만의 시간을 가지며 마음을 정리하는 것이 도움이 됩니다. 오늘의 휴식이 내일의 활력이 될 것입니다. 자신을 돌보는 시간을 가져보세요.",
        ]
        ...
        money_mid = [
            f"재물운이 안정적인 날입니다. 큰 수입은 없지만 지출도 적을 것입니다. 계획적인 소비를 하면 무난한 하루를 보낼 수 있으며, 미래를 위한 저축을 시작하기 좋은 때입니다. 불필요한 충동구매는 자제하고, 꼭 필요한 것만 구입하세요. 작은 절약이 큰 재물을 만듭니다.",
            f"금전적으로 무난한 흐름입니다. 현재 상태를 유지하는 것이 좋으며, 큰 투자나 지출은 피하는 것이 현명합니다. 가계부를 정리하거나 재정 상태를 점검해보는 시간을 가지면 좋겠습니다. 소비 계획을 미리 세워두면 불필요한 지출을 막을 수 있습니다. 오늘은 재정 점검의 날로 삼아보세요.",
        ]
        money_low = [
            f"재물운이 다소 저조한 날입니다. 충동구매나 불필요한 지출을 자제하고, 계획에 없던 소비는 최대한 피하세요. 투자나 도박성 거래는 절대 피해야 하며, 금전 대출이나 보증도 서지 않는 것이 좋습니다. 어려운 시기는 곧 지나갈 것입니다. 내일을 위해 오늘은 아끼세요.",
            f"지갑을 단단히 여미는 것이 좋은 날입니다. 예상치 못한 지출이 발생할 수 있으니 여유 자금을 확보해두세요. 오늘은 돈을 버는 것보다 지키는 것에 집중하세요. 신용카드 사용은 최소화하고 현금 위주로 생활하면 좋겠습니다. 작은 절약이 훗날 큰 도움이 됩니다.",
        ]
        ...
        love_high = [
            f"연애운이 빛나는 날입니다. 싱글이라면 매력적인 이성을 만날 기회가 있으며, {evening_hours}에 특별한 인연이 찾아올 수 있습니다. 연인이 있다면 깊은 대화와 함께 관계가 더욱 돈독해질 것입니다. 상대방에 대한 작은 배려가 큰 감동을 줄 수 있는 날입니다. 사랑하는 마음을 표현하는 것을 두려워하지 마세요.",
            f"사랑의 기운이 충만한 하루입니다. 평소 호감이 있던 사람에게 다가가기 좋은 시기이며, 고백을 계획 중이라면 오늘이 적기일 수 있습니다. 연인과 함께라면 {places}에서 로맨틱한 시간을 보내보세요. 서로에게 진심을 전하면 더욱 깊은 유대감을 느낄 수 있습니다. 오늘의 추억이 오래도록 기억에 남을 것입니다.",
        ]
        love_mid = [
            f"연애운이 평온한 날입니다. 큰 변화보다는 일상의 소소한 애정 표현이 중요합니다. 연인과 함께 조용한 시간을 보내거나, 진솔한 대화를 나눠보세요. 싱글이라면 자연스러운 만남을 기다리는 것이 좋습니다. 무리하게 인연을 찾기보다 자기 자신을 가꾸는 시간을 가지세요.",
            f"사랑에 있어 차분한 흐름입니다. 급하게 관계를 발전시키기보다 서로를 이해하는 시간을 가지세요. 주변 사람들과의 교류를 통해 새로운 인연을 만날 가능성도 있습니다. 친구나 가족과의 시간도 소중히 여기면 좋겠습니다. 사랑은 여유로운 마음에서 찾아옵니다.",
        ]
        love_low = [
            f"연애운이 다소 침체된 날입니다. 연인과의 사소한 오해나 다툼에 주의하고, 감정적인 대화는 피하는 것이 좋습니다. 싱글이라면 오늘은 자기 자신에게 집중하는 시간을 가져보세요. 자기 계발에 투자하면 나중에 더 좋은 인연이 찾아올 것입니다. 내면의 성장이 외적인 매력으로 이어집니다.",
            f"관계에서 신중함이 필요한 날입니다. 상대방의 말에 예민하게 반응하지 말고, 한 발짝 물러서서 상황을 바라보세요. 잠시 거리를 두는 것이 관계에 도움이 될 수 있습니다. 혼자만의 시간을 통해 자신의 감정을 정리해보세요. 차분한 마음이 더 나은 내일을 만듭니다.",
        ]
        ...
        study_high = [
            f"학업운이 최상인 날입니다. 집중력이 크게 향상되어 {morning_hours}부터 {afternoon_hours}까지가 황금 시간대입니다. 어려웠던 개념도 쉽게 이해할 수 있으며, 새로운 공부를 시작하기에도 좋습니다. {places}에서 공부하면 효율이 더욱 높아질 것입니다. 오늘 공부한 내용은 오래도록 기억에 남을 것입니다.",
            f"배움의 운이 트이는 날입니다. 시험을 앞두고 있다면 오늘 집중적으로 공부하세요. 기억력과 이해력이 평소보다 좋아 공부한 내용이 오래 남을 것입니다. 새로운 분야에 도전하거나 자격증 공부를 시작하기에도 좋은 타이밍입니다. 배움에 투자한 시간이 미래의 자산이 됩니다.",
        ]
        study_mid = [
            f"학업에 있어 안정적인 흐름입니다. 새로운 것보다는 복습에 집중하면 좋은 성과를 얻을 수 있습니다. 동료나 스터디 그룹과의 토론도 도움이 됩니다. {action_words_neutral} 공부하는 것이 효과적입니다. 하루 목표를 정하고 차근차근 진행해보세요.",
            f"꾸준히 노력하면 결실을 맺는 날입니다. 무리하지 않는 선에서 학습 계획을 세우고 실천해보세요. 적절한 휴식과 함께 효율적으로 공부하는 것이 중요합니다. 공부와 휴식의 균형을 잘 맞추면 좋은 결과가 있을 것입니다. 작은 성취에도 스스로를 칭찬해주세요.",
        ]
        study_low = [
            f"학업에 집중하기 어려운 날일 수 있습니다. 무리하지 말고 가벼운 복습 위주로 하루를 마무리하세요. 피곤함이 느껴진다면 충분한 휴식을 취한 후 다시 시작하는 것이 낫습니다. {action_words_negative} 접근하세요. 내일 더 좋은 컨디션으로 공부할 수 있을 것입니다.",
            f"컨디션 조절이 필요한 날입니다. 오래 앉아 공부하기보다 짧게 집중하고 자주 쉬는 방식이 효과적입니다. 어려운 내용은 내일로 미루고 오늘은 쉬운 것부터 해보세요. 충분한 수면이 내일의 집중력을 높여줍니다. 몸과 마음을 먼저 챙기세요.",
        ]
        ...
        work_high = [
            f"직장운이 상승하는 날입니다. 당신의 능력과 노력이 인정받을 가능성이 높으며, {afternoon_hours}에 좋은 소식을 들을 수 있습니다. 중요한 미팅이나 발표가 있다면 자신감을 가지고 임하세요. 동료들과의 협업도 원활하게 이루어질 것입니다. 오늘의 성과가 앞으로의 커리어에 좋은 영향을 줄 것입니다.",
            f"커리어에 있어 기회의 날입니다. 새로운 프로젝트나 역할을 맡게 될 수 있으며, {action_words_positive} 임하면 좋은 결과를 얻을 수 있습니다. 상사나 고객에게 좋은 인상을 줄 수 있는 기회가 있습니다. 자신의 의견을 당당하게 표현하면 긍정적인 반응을 얻을 수 있습니다. 오늘 심은 씨앗이 훗날 큰 성과로 돌아올 것입니다.",
        ]
        work_mid = [
            f"업무가 무난하게 흘러가는 날입니다. 큰 성과는 없더라도 맡은 일을 {action_words_neutral} 처리하면 됩니다. 미뤄둔 업무를 정리하기 좋은 때이며, 동료들과 원활한 소통이 가능합니다. 오늘은 기초를 다지는 시간으로 삼으면 좋겠습니다. 작은 일도 성실하게 처리하는 모습이 신뢰를 쌓아줍니다.",
            f"안정적인 업무 흐름입니다. 새로운 도전보다는 현재 진행 중인 일에 집중하세요. 성실함이 장기적으로 좋은 결과를 가져올 것입니다. 업무 중간중간 휴식을 취하며 효율을 높이세요. 동료들과의 소통에도 신경 쓰면 팀 분위기가 좋아질 것입니다.",
        ]
        work_low = [
            f"직장에서 {action_words_negative} 행동하는 것이 좋겠습니다. 중요한 결정이나 새로운 제안은 미루고, 평소 하던 일에만 집중하세요. 동료나 상사와의 의견 충돌에 주의하고, 감정적인 대응은 피하세요. 오늘은 묵묵히 주어진 일만 처리하는 것이 현명합니다. 내일 더 좋은 기회가 찾아올 것입니다.",
            f"업무 스트레스가 있을 수 있는 날입니다. 완벽함을 추구하기보다 무난하게 하루를 마무리하는 것을 목표로 하세요. 실수를 줄이기 위해 중요한 일은 이중 체크하세요. 퇴근 후에는 충분한 휴식을 취하며 에너지를 충전하세요. 어려운 시기는 반드시 지나갑니다.",
        ]
        ...
        health_high = [
            f"건강운이 좋은 날입니다. 몸과 마음 모두 활력이 넘치며, 새로운 운동을 시작하기에 좋은 시기입니다. {morning_hours}에 가벼운 운동으로 하루를 시작하면 상쾌한 기분이 종일 유지될 것입니다. 충분한 수분 섭취도 잊지 마세요. 오늘의 활력이 내일까지 이어질 것입니다.",
            f"에너지가 넘치는 하루입니다. 평소 하고 싶었던 야외 활동이나 운동을 즐기기 좋습니다. 면역력도 좋은 상태이니 건강 검진이나 운동 계획을 실행해보세요. 균형 잡힌 식사와 함께 건강한 생활 습관을 유지하세요. 오늘 쌓은 체력이 내일의 원동력이 됩니다.",
        ]
        health_mid = [
            f"건강운이 안정적인 날입니다. 무리하지 않는 선에서 규칙적인 생활을 유지하면 좋겠습니다. 가벼운 스트레칭이나 산책이 도움이 되며, 충분한 수면도 중요합니다. 음식은 소화가 잘 되는 것 위주로 드시세요. 몸과 마음의 균형을 유지하는 것이 중요합니다.",
            f"몸 상태가 평온한 날입니다. 자극적인 음식은 피하고, 균형 잡힌 식사를 하세요. 틈틈이 휴식을 취하며 컨디션을 유지하는 것이 중요합니다. 오후에는 가벼운 스트레칭으로 긴장을 풀어주세요. 작은 건강 습관이 큰 차이를 만듭니다.",
        ]
        health_low = [
            f"건강 관리에 신경 써야 하는 날입니다. 무리한 활동은 피하고, {evening_hours}에는 일찍 휴식을 취하세요. 소화가 안 될 수 있으니 가벼운 음식 위주로 드시고, 충분한 수면이 필요합니다. 몸이 보내는 신호에 귀 기울이세요. 오늘 쉬어야 내일 더 건강해집니다.",
            f"컨디션이 떨어질 수 있는 날입니다. 격한 운동보다는 가벼운 스트레칭 정도가 적합하며, 몸의 신호에 귀 기울이세요. 충분히 쉬면 내일은 회복될 것입니다. 따뜻한 물을 자주 마시고 실내 온도를 적정하게 유지하세요. 자기 자신을 아끼는 시간을 가지세요.",
        ]
    ...
    def _determine_lucky_item(self, zodiac_sign: str, today: date, user_id: int = None, session_key: str = None, lucky_colors: List[str] = None, fortune_score: int = 70, fortune_scores: Dict = None) -> Dict:
        ...
        # 별자리 아이템 선택 (날짜별 순환 - 4개 중 1개)
        zodiac_item_list = zodiac_items.get(zodiac_sign, [
            ('반지', '💫', '당신에게 반지는 전반적인 행운을 가져다줍니다. 오늘 하루 반지를 착용하고 긍정적인 마음으로 보내면 좋은 일이 생길 것입니다.')
        ])
        # 날짜의 일(day)을 4로 나눈 나머지로 아이템 선택 (1~4일: 0, 5~8일: 1, ...)
