...
class FortuneCalculator:
    ...
    def _build_fortune_prompt(
        ...
        if period_type == 'weekly':
            ...
            timing_guide = """
   - **절대 사용 금지**: "오전 9시", "오후 3시" 등 구체적인 시간, "길일", "~한 날입니다" 등 일일 표현
   - **필수 5문장 구조 (반드시 이 형식으로)**:
     1번째 문장: 이번 주 전체 총운 요약
     2번째 문장: "평일 초(월~화)에는 ~합니다." 형식
     3번째 문장: "평일 말(수~금)에는 ~합니다." 형식
     4번째 문장: "주말(토~일)에는 ~합니다." 형식
     5번째 문장: 이번 주 운세 흐름 요약 및 조언
   - 예시: "이번 주는 전반적으로 활기찬 기운이 감돕니다. 평일 초(월~화)에는 새로운 시작에 유리합니다. 평일 말(수~금)에는 중요한 결정을 내리기 좋습니다. 주말(토~일)에는 휴식을 취하며 재충전하세요. 한 주 동안 꾸준히 노력하면 좋은 결과가 있을 것입니다.\""""
            item_period = '이번 주'
            ...
            timing_guide = """
   - **절대 사용 금지**: "오전 9시", "오후 3시" 등 구체적인 시간, "이번 주", "길일", "~한 날입니다" 등
   - **필수 5문장 구조 (반드시 이 형식으로)**:
     1번째 문장: 이번 달 전체 총운 요약
     2번째 문장: "월초(1~10일)에는 ~합니다." 형식
     3번째 문장: "월중(11~20일)에는 ~합니다." 형식
     4번째 문장: "월말(21일~)에는 ~합니다." 형식
     5번째 문장: 이번 달 운세 흐름 요약 및 조언
   - 예시: "이번 달은 성장과 발전의 기운이 강합니다. 월초(1~10일)에는 계획을 세우기 좋습니다. 월중(11~20일)에는 실행에 옮기면 성과가 있습니다. 월말(21일~)에는 마무리와 정리에 집중하세요. 한 달 동안 차근차근 진행하면 원하는 결과를 얻을 수 있습니다.\""""
            item_period = '이번 달'
        else:  # daily
            period_title = '오늘의 운세'
            period_word = '오늘'
