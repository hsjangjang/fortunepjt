...
if _allowed_hosts:
    ...
    # 개발 환경에서는 모든 호스트 허용 (프로덕션에서는 특정 도메인으로 제한 권장)
    if DEBUG:
        ALLOWED_HOSTS = ['*']
    else:
...
# Gemini 모델용 (gemini-2.0-flash 등) - 이미지 분석에 사용
GMS_GEMINI_BASE_URL = config('GMS_GEMINI_BASE_URL', default='https://gms.ssafy.io/gmsapi/gemini.googleapis.com/v1beta')
