      ...
      <div class="col-lg-5 col-12 mx-auto px-1 px-md-3">
        <div class="glass-card shadow-lg">
          <div class="card-body responsive-padding">
            ...
            <form @submit.prevent="handleChangePassword">
              ...
              <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg" :disabled="loading">
                  <span v-if="loading">
                    <i class="fas fa-spinner fa-spin"></i> 변경 중...
                  </span>
                  <span v-else>
            ...
            <hr v-if="!mustChange" class="my-4 border-secondary">

            <div v-if="!mustChange" class="text-center">
              <router-link to="/profile" class="text-decoration-none text-white-50">
                <i class="fas fa-arrow-left"></i> 프로필로 돌아가기
              </router-link>
            </div>
          </div>
        </div>
  ...
  try {
    ...
    if (errors) {
      if (errors.old_password) {
        ...
        showToast(errors.new_password2[0], 'error')
      } else {
