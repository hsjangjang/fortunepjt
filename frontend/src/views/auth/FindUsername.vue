          ...
          <div class="card-body responsive-padding">
            ...
            <div v-if="sent" class="text-center mb-4">
              ...
              <div class="d-grid gap-2 mt-4">
                ...
                <router-link to="/find-password" class="btn btn-outline-light">
                  비밀번호도 찾기
                </router-link>
              </div>
            </div>
            ...
            <form v-else @submit.prevent="handleFindUsername">
              <div class="mb-4">
                ...
                <small class="text-white-50">가입하신 이메일로 아이디 정보를 보내드립니다.</small>
              </div>
              ...
              <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg" :disabled="loading">
                  ...
                  <span v-else>
                    <i class="fas fa-paper-plane"></i> 아이디 찾기
                  </span>
                </button>
              </div>
            </form>
            ...
            <div class="text-center">
              ...
              <router-link to="/find-password" class="text-decoration-none text-white-50">
